...
/**
 * The WebCrawler service is where the actual operations related to
 * parsing the web page and analysing the web page is residing.
 * 
 * This service analyses the webpage and finds the urls which are
 * located inside the webpage. It checks which and groups all the 
 * internal and external urls which are found in the web page.
 * 
 * It also checks whether the urls were redirected to some other pages
 * and it reports accordingly.
 * 
 * @author Nigel
 *
 */
...
public class WebCrawlerService {
	...
	/**
	 * Analyse the URL and the internal and external urls which
	 * are found inside the web page of the url.
	 * 
	 * @param url
	 * @return
	 ...
	 * 
	 * Since the amount of urls which are there inside the page
	 * is huge, this is pinging and analysis of the url
	 * is done concurrently using Java's Executor Service.
	 * 
	 * @param internalUrl
	 * @param linkDto
	 */
